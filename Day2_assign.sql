...
CREATE TRIGGER tr_prevent_customer_deletion
ON sales.customers
INSTEAD OF DELETE
AS
BEGIN
...
VALUES 
('John', 'Doe', 'john.doe@example.com', 60000.00, '2022-01-15'),
('Jane', 'Smith', 'jane.smith@example.com', 65000.00, '2023-03-20'),
('Bob', 'Johnson', 'bob.johnson@example.com', 55000.00, '2021-07-25');
...
UPDATE Employee
SET Salary = 70000
WHERE EmployeeID = 1; -- Update John's salary
...
WHERE EmployeeID = 2; -- Delete Jane Smith
...
VALUES 
(1, 'Alice Johnson', '2024-11-01', '2024-11-05'),
(2, 'Bob Smith', '2024-11-03', '2024-11-06');
